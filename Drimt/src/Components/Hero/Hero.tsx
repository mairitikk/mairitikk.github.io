  ...
  return (
    <div className='flex items-center flex-col gap-9'>
          ...
          <div className="flex items-center gap-25 text-2x1 font-medium mb-[50px]">
              <Button className=" text-[18px] bg-gradient-to-r from-[#EBEFF5] to-[#3A3AF8] px-10 py-5 rounded-full cursor-pointer">Connect with me</Button>
              <Button variant="outline" className='text-[18px] rounded-full cursor-pointer px-10 py-5 '>My resume</Button>
    </div>
      </div>
  )
}
